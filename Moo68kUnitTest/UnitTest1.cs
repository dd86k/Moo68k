...
namespace Moo86kUnitTest
{
    ...
    public class Moo86kUnitTest
    {
        ...
        public void TestDataRegisters()
        {
            ...
            Assert.AreEqual(m68k.D0, 5u);
            m68k.Execute(0x223C, 5);
            Assert.AreEqual(m68k.D1, 5u);
            m68k.Execute(0x243C, 5);
            Assert.AreEqual(m68k.D2, 5u);
            m68k.Execute(0x263C, 5);
            Assert.AreEqual(m68k.D3, 5u);
            m68k.Execute(0x283C, 5);
            Assert.AreEqual(m68k.D4, 5u);
            m68k.Execute(0x2A3C, 5);
            Assert.AreEqual(m68k.D5, 5u);
            m68k.Execute(0x2C3C, 5);
            Assert.AreEqual(m68k.D6, 5u);
            m68k.Execute(0x2E3C, 5);
            Assert.AreEqual(m68k.D7, 5u);
